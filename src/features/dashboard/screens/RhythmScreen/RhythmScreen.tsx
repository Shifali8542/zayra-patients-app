...
import { consistencyAreas } from '../../../../mocks/mockData';
...
export function RhythmScreen({ streak }: RhythmScreenProps) {
          ...
          {streak.milestones.map((m) => {
            ...
            return (
              <View key={m.label} style={[styles.milestoneCard, { backgroundColor: bgColor }]}>
                ...
                <Text style={[styles.milestoneNum, { color: textColor, fontFamily: theme.fonts.displayBold, fontSize: theme.fontSize.xl }]}>
                  {m.days}
                </Text>
                <Text style={[styles.milestoneLabel, { color: textColor, fontFamily: theme.fonts.sansSemiBold, fontSize: theme.fontSize.xxs, opacity: 0.8 }]}>
                  {m.label}
                </Text>
              </View>
            );
